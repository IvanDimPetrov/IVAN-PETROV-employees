...
- Create Angular project with ng: `ng new employeereports.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeereports.client.esproj`).
